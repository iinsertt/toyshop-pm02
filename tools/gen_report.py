...
def section_development(styles):
    ...
    story.append(h2(styles, "4.1 Пример работы программы (консольный интерфейс)"))
    story.append(body(styles, "Ниже приведён фрагмент работы программы — главное меню и "
        "оформление заказа."))
    console = (
        "==============================\n"
    ...
    story.append(code_block(styles, console))
    story.append(Paragraph("Рисунок 3 — Оформление заказа в консоли", styles["GostCaption"]))
